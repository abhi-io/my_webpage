...
<?php
		...
		$ev=$_POST['nam'];
               echo '<table class="table table-striped table-bordered table-hover">';
                            ...
                            echo '<tbody>';
							 ...
							 include '../link.php';
							 $po=0;
							 $sel=mysql_query("select distinct name,institution,mob,email,event from register where event='$ev'");
							 while($row=mysql_fetch_array($sel))
	{
							 $po++;
                                echo '<tr>';
	...
	<tr>
	<td style="width:20%">
	<label for="name">Event to download</label>
	</td>
	<td style="width:*%">
