...
<body>
 ...
 <li >
            ...
            <div id="page-inner">
			  ...
			  echo '<table class="table table-striped table-bordered table-hover">';
                            ...
                            echo '<tbody>';
							 ...
							 include '../link.php';
							 $sel=mysql_query("select * from tech");
  ...
  ?>
			  ...
			  <form method="post" action="../action/ete.php" enctype="multipart/form-data">
	<table border="0" style="width:100%">
	<tr>
	<td style="width:20%">
	...
	<td style="width:*%">
	<br><img width=200 height=150 src="../action/tech/<?php echo htmlspecialchars($z);?>">
