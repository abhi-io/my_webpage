...
<body>
 ...
 <li >
            ...
            <div id="page-inner">
			  ...
			  echo '<table class="table table-striped table-bordered table-hover">';
                            ...
                            echo '<tbody>';
							 ...
							 include '../link.php';
							 $sel=mysql_query("select * from work");
  ...
  ?>
			  ...
			  <form method="post" action="../action/ew.php" enctype="multipart/form-data">
	<table border="0" style="width:100%">
	<tr>
	<td style="width:20%">
	...
	<td style="width:*%">
	<br><img width=200 height=150 src="../action/work/<?php echo htmlspecialchars($z);?>">
	...
	<td style="width:*%">
	 ...
	 <input type="text" name="link"  value= "<?php echo htmlspecialchars($q);?>" >
	 </td>
	 </tr>
			 </table>
<br>
