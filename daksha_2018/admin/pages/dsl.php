            ...
            <div id="page-inner">
			  ...
			  <?php
                      ...
                      ?>          
								...
								<img width=200 height=150 src="../action/slider/<?php echo htmlspecialchars($sli);?>" alt="" />
			  ...
			  ?>
			   ...
			   <form method="post" action="../action/dsl.php" enctype="multipart/form-data">
	<table border="0" style="width:100%">
	<tr>
	<td style="width:20%">
	<label for="name">slide to delete</label>
	</td>
	<td style="width:*%">
